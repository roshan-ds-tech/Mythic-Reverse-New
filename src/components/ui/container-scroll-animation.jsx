...
export const ContainerScroll = ({
    ...
    return (
        <div
            className="h-[30rem] md:h-[45rem] flex items-center justify-center relative p-2"
            ref={containerRef}
        >
            <div
...
export const Card = ({
    ...
    return (
        ...
        >
            <div className=" h-full w-full overflow-hidden rounded-2xl bg-[#09090b] md:rounded-2xl md:p-4 ">
                {children}
            </div>
        </motion.div>
    );
